          ...
          <div className="space-y-4">
            {checklistItems.map((item, index) => (
              <motion.div
                ...
                className="group bg-white rounded-[28px] sm:rounded-[32px] px-5 sm:px-7 py-5 sm:py-6 border border-[rgba(15,23,42,0.05)] shadow-sm hover:shadow-md transition-all duration-300 flex items-center gap-4"
